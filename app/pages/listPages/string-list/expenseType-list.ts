...
import {ExpenseTypeModal} from '../../addPages/add-string/add-expenseType';
...
export class ExpenseTypeListPage {
    ...
    constructor(
        ...
        this.companyService.get(dataService.companyId).subscribe((val) => {
            this.elements = companyService.getExpenseType(val);
        });
    }
    details: string[];
    locations: string[];
    ...
    public addElement() {
        this.nav.push(ExpenseTypeModal, { animate: true, direction: 'up' });
    }
